<div class="social-main">
	<?php if (!get_option('ygj_post_like') ) { ?>
		...
		<span class="liubaixx">
		<div class="shang clr">	
			<a  title="好文！一定要打赏！" class="dashang" href="JavaScript:void(0)"><i class="fa fa-gift" aria-hidden="true"></i>赞赏<span><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/dashang.jpg" alt="打赏二维码"></span></a>
		</div>
		</span>
		<?php } ?>
