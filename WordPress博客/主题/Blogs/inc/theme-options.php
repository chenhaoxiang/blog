...
$options = array(
	...
	array(	"name" => "首页公告栏内容",
            ...
            "id" => "ygj_ggl_nr",
            "type" => "textarea",
            "std" => '<li class="scrolltext-title"><a href="http://yigujin.cn/nana/" rel="bookmark" target="_blank">WordPress免费响应式主题:Nana</a></li><li class="scrolltext-title"><a href="http://yigujin.cn/blogs/" rel="bookmark" target="_blank">WordPress/zblogPHP免费响应式博客主题Blogs</a></li>'),
...
版权声明：本文为原创文章，版权归 懿古今 所有，欢迎分享本文，转载请保留出处！'
	...
	array(	"name" => "导航栏下方广告代码（PC端）",
            ...
            "id" => "ygj_addd_c",
            "type" => "textarea",
            "std" => '<a href="http://boke112.com/" target="_blank"><img src="' . get_template_directory_uri() . '/images/abc/blogs.jpg" alt="boke112导航_独立博客导航平台" /></a>'),
	...
	array(	"name" => "首页(列表页)第一广告代码（PC端）",
            ...
            "id" => "ygj_adh_c",
            "type" => "textarea",
            "std" => '<a href="http://boke112.com/" target="_blank"><img src="' . get_template_directory_uri() . '/images/abc/boke112.jpg" alt="boke112导航_独立博客导航平台" /></a>'),
	...
	array(	"name" => "首页(列表页)第二广告代码（PC端）",
            ...
            "id" => "ygj_adh_cx",
            "type" => "textarea",
            "std" => '<a href="http://yigujin.cn/blogs/" target="_blank"><img src="' . get_template_directory_uri() . '/images/abc/blogs.jpg" alt="WordPress免费响应式主题：Blogs主题" /></a>'),
	...
	array(	"name" => "下载弹窗广告",
            ...
            "id" => "ygj_file_ad",
            "type" => "textarea",
            "std" => '<a href="http://boke112.com/" target="_blank"><img style="width:100%;" src="' . get_template_directory_uri() . '/images/abc/500.jpg" alt="boke112导航_独立博客导航平台" /></a>'),
    array(
        'type'  => 'panelend'
    ),
	array(
...
<div class="wrap">
    ...
    <div class="ygjtips">    
    <p>当前主题:Nana&nbsp;3.19&nbsp;版 | 设计者：<a href="http://yigujin.cn/" target="_blank">懿古今</a> | <a href="http://yigujin.cn/987.html" target="_blank">了解加入Nana主题群（28724788）</a> | <a href="http://yigujin.cn/722.html" target="_blank">赞助20元去版权</a> | 申请免费收录到 <a href="http://boke112.com/" target="_blank">boke112导航</a> </p>
    </div>
	<?php //获取所有站点分类id
...
function ygj_pointer_print_scripts() {
    ...
    jQuery(document).ready(function($) {
        ...
        $menuAppearance.pointer({
            content: '<h3>恭喜，Nana 主题3.19安装成功！</h3><p>该主题支持选项，请访问<a href="themes.php?page=theme-options.php">主题选项</a>页面进行配置。</p>',
            position: {
                edge: "left",
                align: "center"
            },
